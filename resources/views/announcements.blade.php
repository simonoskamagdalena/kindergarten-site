...
@foreach($posts as $post)
    ...
    @if($post->image)
        <div >
            <a href="#"><img src="{{route('image',['filename' => $post->image])}}" alt=""></a>
        </div>
    @elseif(!$post->image)
        <div>
            <a href="#"><img src="{{asset('images/placeholder.jpg')}}" alt=""></a>
        </div>
    @endif
    {{$post->title}} </li>
...
@section('title')
<title>PrimeKidz | Announcements</title>
@endsection
                            ...
                            <div class="inner-box">
                               ...
                               <a href="{{route('post-details',$post)}}">
                                ...
                                <div class="lower-content">
                                    ...
                                    <a  href="{{route('post-details',$post)}}" class="read-more">Read more</a>
                                </div>
                            </div>
                        </div>
                        <!-- End News Block -->
